...
Here, we prioritize privacy and security very seriously and we've been conscious about it since day one,
because we're aware that furry nerds are so good at IT stuff and we'd love to see that in-action here!

That being said, we encourage everyone (including furry nerds, bug hunters, researchers, or you 👀) to participate
in our program and responsibly find, disclose, and help us resolve security vulnerabilities.
...
# Report Submissions
At the moment, every issues must be submitted through the [GitHub Security Advisory](https://github.com/anthro-id/security-disclosure/security/advisories/new). You have to explain the issue thoroughly, like what impacts it, how big the blast radius is, what users should do to avoid the bug at the moment, etc.
...
# Out of Scope
When reporting a vulnerability, please consider the (a) attack scenario, and (b) the impact.
The following issues are generally considered out of scope, including but not limited to:
...
# Credits
A huge thank you to [Zeru 🖼️](https://link.anthro.id/NxqmYg) for the banner commission!